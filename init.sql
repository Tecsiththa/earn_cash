...
VALUES (
    'Big Buck Bunny',
    'Watch this amazing animated short film',
    'https://example.com/bigbuckbunny',
  ...
  (
    'Elephants Dream',
    'Experience this creative animation',
    'https://example.com/elephantsdream',
  ...
  (
    'For Bigger Blazes',
    'Watch this exciting advertisement',
    'https://example.com/forbigger',
